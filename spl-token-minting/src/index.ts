...
async function createTokenMetadata(
  ...
  // file to buffer
  const buffer = fs.readFileSync("assets/tiger.png");

  // buffer to metaplex file
  const file = toMetaplexFile(buffer, "tiger.png");
...
async function main() {
  ...
  const mint = await createNewMint(
    connection,
    user, // we will pay the fees
    user.publicKey, // we are the mint authority
  ...
  await createTokenMetadata(
    ...
    user,
    "Tiger", // Token name - REPLACE THIS WITH YOURS
    "TGR", // Token symbol - REPLACE THIS WITH YOURS
